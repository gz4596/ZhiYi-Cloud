...
import com.github.taoroot.cloud.common.security.social.SocialTypeEnum;
...
@Log4j2
@Component(SocialTypeEnum.WX_OPEN)
@AllArgsConstructor
public class WxOpenLoginHandler extends AbstractSocialLoginHandler {
    ...
    public String identify(String code) {
        AdminSocialDetails socialDetails = socialDetailsMapper
                .selectOne(Wrappers.<AdminSocialDetails>lambdaQuery().eq(AdminSocialDetails::getType, SocialTypeEnum.WX_OPEN));
        String uri = String.format(SocialTypeEnum.WX_OPEN_AUTHORIZATION_CODE_URL,
        ...
        log.debug("{}:{} --> {}", SocialTypeEnum.WX_OPEN, code, body);
    ...
    public AuthUserInfo info(String openId) {
        AdminUserSocial userSocial = userSocialMapper.selectOne(Wrappers.<AdminUserSocial>lambdaQuery()
                .eq(AdminUserSocial::getSocialType, SocialTypeEnum.WX_OPEN)
