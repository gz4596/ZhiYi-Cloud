...
INSERT INTO `admin_role_authority` (`role_id`, `authority_id`) VALUES (1,10),(1,11),(1,12),(1,13),(1,14),(1,1000),(1,1001),(1,1002),(1,1003),(1,1004);
...
--
-- Table structure for table `admin_user_oauth2`
--

DROP TABLE IF EXISTS `admin_user_oauth2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `admin_user_oauth2` (
  ...
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `admin_user_oauth2_pk` (`client_registration_id`,`principal_name`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `admin_user_oauth2`
--

INSERT INTO `admin_user_oauth2` (`client_registration_id`, `principal_name`, `created_at`, `user_id`, `nickname`, `avatar`, `id`) VALUES ('gitee','1603766','2020-09-03 08:12:59','1','taoroot',NULL,105);
